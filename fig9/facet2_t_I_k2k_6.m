...
[T1,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I1=[];
for i=1:length(T1)
    sum=0;
...
[T2,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I2=[];
for i=1:length(T2)
    sum=0;
...
[T3,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I3=[];
for i=1:length(T3)
    sum=0;
...
[T4,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I4=[];
for i=1:length(T4)
    sum=0;
...
[T5,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I5=[];
for i=1:length(T5)
    sum=0;
...
[T6,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I6=[];
for i=1:length(T6)
    sum=0;
...
[T7,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I7=[];
for i=1:length(T7)
    sum=0;
...
[T8,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I8=[];
for i=1:length(T8)
    sum=0;
...
[T9,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I9=[];
for i=1:length(T9)
    sum=0;
...
[T10,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I10=[];
for i=1:length(T10)
    sum=0;
...
[T11,X1]=ode45(@distribution_fun, [0 200] ,X0);
%把每个时刻的所有I加起来
I11=[];
for i=1:length(T11)
    sum=0;
